...
pub use c_player_info_update::{CPlayerInfoUpdate, PlayerInfoAction, PlayerInfoEntry};
...
pub use s_container_click::{ClickType as ProtocolClickType, SContainerClick, SlotChange};

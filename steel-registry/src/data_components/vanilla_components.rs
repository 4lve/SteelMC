...
// Re-export component types from the components module
pub use super::components::{Equippable, EquippableSlot, Tool, ToolRule};
// Re-export value newtypes
pub use super::values::{Damage, MaxDamage, MaxStackSize, RepairCost};
...
pub const MAX_STACK_SIZE: DataComponentType<MaxStackSize> =
    DataComponentType::new(Identifier::vanilla_static("max_stack_size"));

pub const MAX_DAMAGE: DataComponentType<MaxDamage> =
...
pub const REPAIR_COST: DataComponentType<RepairCost> =
